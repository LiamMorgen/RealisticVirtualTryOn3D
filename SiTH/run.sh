...
echo "Reconstructing textured 3D meshes..., in data/work_test_examples"
python reconstruct.py --test_folder data/work_test_examples --config recon/config.yaml --resume checkpoints/recon_model.pth